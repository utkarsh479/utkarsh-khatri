...
<body>
    ...
    <header class="page-header">
        <h1>Find Bed in your favourite Hospital</h1>
    ...
    <section class="popular-hospitals">
        <div class="container">
            ...
            <div class="hospital-images">
                <img src="cityhospital.jpg" alt="City Hospital" onclick="window.location.href='bedavb.php'">
                <img src="jnu.jpg" alt="JNU Hospital" onclick="window.location.href='bedavb2.php'">
                <img src="fortis.jpg" alt="Fortis Hospital" onclick="window.location.href='bedavb3.php'">
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        const hospitals = [
            { name: 'City Hospital', link: 'bedavb.php' },
            { name: 'JNU Hospital', link: 'bedavb2.php' },
            { name: 'Fortis Hospital', link: 'bedavb3.php' },
        ];
