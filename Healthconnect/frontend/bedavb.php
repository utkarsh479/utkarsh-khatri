...
$systolicbp=$_GET['systolicbp'];
$diastolicbp=$_GET['diastolicbp'];
$severity=$_GET['severity'];
$comments=$_GET['comments'];

$query="INSERT INTO BOOKBED VALUES ('$firstname','$lastname','$age','$ward','$heartrate','$systolicbp','$diastolicbp','$severity','$comments')";
