...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1>City Hospital - Bed Booking</h1>
        ...
        if ($total > 0) {
            while ($result = mysqli_fetch_assoc($data)) {
                ...
                <tr>
                    ...
                    <td>" . htmlspecialchars($result['ward']) . "</td>
                    <td>" . htmlspecialchars($result['heartrate']) . "</td>
                    <td>" . htmlspecialchars($result['systolicbp']) . "</td>
                    <td>" . htmlspecialchars($result['diastolicbp']) . "</td>
                    <td>" . htmlspecialchars($result['severity']) . "</td>
